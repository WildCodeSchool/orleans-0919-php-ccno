...
class ActivityController extends AbstractController
{
    ...
    public function course()
    {
        ...
        ['public' => 'Pour Tous',
            ...
            'link' => 'https://ccn-orleans-reservations.mapado.com/event/orleans/samedi-brunch-avec-lenio-kaklea-en-residence-au-ccno-pour-encyclopedie-pratique-deuxieme-volet-titre-provisoire',
            ],
        ];
    ...
    public function formation()
    {
        $activities = [
            ...
            'price' => '50€ le weekend',
                'link' => 'https://ccn-orleans-reservations.mapado.com/event/orleans/groove-nation-week-end-dimmersion-danses-afro-americaines-avec-la-compagnie-engrenage-s',
            ],
        ];
